...
questions = Question.create([{text: 'Describe the situation in which you demonstrated your highest level of ambition.', comptency_id: '1'}, {text: 'What does a successful life look like to you?', competency_id: '1'}, {text: 'Describe in detail how you would go about web-optimization for raw HD video.', competency_id: '2'}, {text: 'Outline the steps for transforming a 2D illustration into a 3d printed piece.', competency_id: '2'}, {text: 'How would you try to determine the number of barbers needed for a city of 50,000 people', competency_id: '3'}, {text: 'Imagine you are lost, alone in a foreign country and do not speak the language, how do you get home?', competency_id: '3'}, {text:'What advice would you give to a friend relocating to a foreign country?', competency_id: '4'}, {text: 'Your next project for work has you collaborating on a global team. How do you ensure clear communication?', competency_id: '4'}, {text: 'Describe a time when a colleague was working below expectations. What was your response and what was the ultimate outcome?', competency_id: '5'}, {text: 'What is the toughest group you had to get cooperation from? Describe how you handled it and the final outcome.', competency_id: '5'}, {text: 'Describe a time you had a positive impact on somone.', competency_id: '6'}, {text: 'How could you create more balance in your life?', competency_id: '6'}, {text: 'What do you find most rewarding about your favorite leisure activity?', competency_id: '7'}, {text: 'If you could take a year off (with pay) what would you do?', competency_id: '7'}, {text: 'If you were an animal, what would you be and why?', competency_id='8'}, {text: 'Describe how the role of Operations Manager demonstrates our corporate values.', competency_id: '8'}])
